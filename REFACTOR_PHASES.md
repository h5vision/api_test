...
| 8 | complete | `c0c48ffb2a51d52cbceeb47d627b71fd845fe60a` | this commit | Split generation into catalog/routing/context/contracts, move provider HTTP transport into `integrations/ai_server/`, and preserve the legacy `backend.generation` module through an alias. |
