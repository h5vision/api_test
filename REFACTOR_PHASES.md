...
| 5 | complete | `a95a4f3e8fc8f32a184ba2eeb33bb627959f2762` | this commit | Move GitHub Snapshot adapter implementations under `integrations/github/` and keep legacy import paths as compatibility shims. |
